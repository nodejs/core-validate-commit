...
export const rightPad = function rightPad (str, max) {
...
export const leftPad = function leftPad (str, max) {
  const diff = max - str.length + 1
  if (diff > 0) {
...
export const header = (sha, status) => {
  switch (status) {
    case 'skip':
    case 'pass': {
...
export const describeRule = function describeRule (rule, max = 20) {
...
export const describeSubsystem = function describeSubsystem (subsystems, max = 20) {
  if (subsystems) {
